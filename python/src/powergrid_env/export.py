"""
Serialization of an sb3 MaskablePPO policy network to the flat PGRLPOL6 binary
...
def value_state_dict_to_bytes(state_dict) -> bytes:
    ...
    Layout mirrors PGRLPOL6: magic + (obs_size, hidden, out_dim=1) + the six
